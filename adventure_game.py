...
def intro():
    ...
    print_pause()
    print(
        "You find yourself standing in an open jungle, filled with trees and",
        " animals.",
    )
    print_pause()
    print(
        "Rumor has it that a huge creature is somewhere around here, and has",
    ...
    print_pause()
    print(
        f"In your hand you hold your a {ur_weapon} and"
        "a {ur_secweapon} (but the {ur_secweapon} is not very effective) ."
    )
    print_pause()
...
def house():
    ...
    if woman == "1":
        ...
        print_pause()
        print(
            "the woman told you that the"
              " creature is hiding in the village's river")
        print_pause()
        print("now you are going to the river to kill the creature")
        print_pause()
        print("now you  aproached to riverbank")
        print("you saw the creature ")
        print_pause()
        print("you fight the creature and killed it !")
        print_pause()
        print("there is a champion ! ")
        print_pause()
        ...
        print(
            "the woman refused to tell "
            "you the place of the creature  and kicked you out of her house"
        )
        print_pause()
